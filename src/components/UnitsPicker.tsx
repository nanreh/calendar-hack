    ...
    return (
        <ControlCard>
            ...
            <div className="switch-field">
                <input type="radio" name="units" id="Miles" value="mi" checked={units === 'mi'} onChange={handleChangeFn} />
                <label htmlFor="Miles">Mi</label>
                <input type="radio" name="units" id="Kilometers" value="km" checked={units === 'km'} onChange={handleChangeFn} />
