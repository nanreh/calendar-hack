...
const WeekStartsOnPicker: React.FC<Props> = ({ weekStartsOn, changeHandler }) => {
    ...
    return (
        <Root>
            ...
            <Select value={weekStartsOn} onChange={handleChange}>
                <option key="monday" value={WeekStartsOnValues.Monday}>Monday</option>
                <option key="sunday" value={WeekStartsOnValues.Sunday}>Sunday</option>
                <option key="saturday" value={WeekStartsOnValues.Saturday}>Saturday</option>
            </Select>
        </Root>
    )
}
