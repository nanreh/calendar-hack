...
export type WeekStartsOn = typeof WeekStartsOnValues[keyof typeof WeekStartsOnValues];

// plan always has numOfDays % 7 === 0
export function calcPlanDates(numWeeksInPlan: number, planEndsOn: Date, weekStartsOn: WeekStartsOn): PlanDates {
    ...
    const start = startOfDay(startOfWeek(planStartsOn, { weekStartsOn: weekStartsOn }));
